...
from post_train_v2.src.training.lora import apply_lora
from post_train_v2.src.training.supervised import run_supervised_training


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train V2 LoRA SFT with DDP.")
    parser.add_argument(
        "--config",
        default="post_train_v2/configs/sft/lora.yaml",
    )
