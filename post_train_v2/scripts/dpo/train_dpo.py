...
from post_train_v2.src.training.dpo import run_dpo_training


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train V2 DPO with DDP.")
    parser.add_argument("--config", default="post_train_v2/configs/dpo/train.yaml")
