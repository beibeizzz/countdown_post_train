...
from post_train_v2.verl.data.conversion import convert_jsonl_to_parquet


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Convert Countdown JSONL to verl Parquet.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    convert_jsonl_to_parquet(
        ...
        output_parquet=output_dir / "validation.parquet",
        expected_count=50,
    )
